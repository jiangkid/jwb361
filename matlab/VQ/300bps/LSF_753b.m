...
LSF_CB_753_7 = codeBookTrain(train_signal, stage1_b);
%Vector Quantization
for i = 1:length
    distance = pdist2(train_signal(i,:), LSF_CB_753_7);
    [value, idx] = min(distance);
    VQ1(i) = idx;
    residStage1(i,:) = train_signal(i,:) - LSF_CB_753_7(idx,:);    
end
disp('stage1 completed');

%stage2, train with residual of stage1
LSF_CB_753_5 = codeBookTrain(residStage1, stage2_b);
%Vector Quantization
for i = 1:length
    distance = pdist2(residStage1(i,:), LSF_CB_753_5);
    [value, idx] = min(distance);
    VQ2(i) = idx;
    residStage2(i,:) = residStage1(i,:) - LSF_CB_753_5(idx,:);  
end
disp('stage2 completed');

%stage3, train with residual of stage2
LSF_CB_753_3 = codeBookTrain(residStage2, stage3_b);
save('LSF_CB_753b.mat', 'LSF_CB_753_7', 'LSF_CB_753_5', 'LSF_CB_753_3');
%Vector Quantization
for i = 1:length
    distance = pdist2(residStage2(i,:), LSF_CB_753_3);
    [value, idx] = min(distance);
    VQ3(i) = idx;
    residStage3(i,:) = residStage2(i,:) - LSF_CB_753_3(idx,:);  
end
