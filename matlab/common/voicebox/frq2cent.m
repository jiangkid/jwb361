...
%FRQ2ERB  Convert Hertz to Cents frequency scale MEL=(FRQ)
%	[c,cr] = frq2mel(frq) converts a vector of frequencies (in Hz)
%	to the corresponding values on the logarithmic cents scale.
%   100 cents corresponds to one semitone and 440Hz corresponds to 5700 cents
%
...
%      Version: $Id: frq2cent.m 3101 2013-06-13 16:06:37Z dmb $
%
