...
int main(int argc, char *argv[])
{
    ...
    FILE	*fp_in, *fp_out;
    unsigned long wavhealen, pcmLen;
...
#if (WAV)
    wavhealen = wav_header_len(fp_in, fp_out, mode, pcmLen);
#endif
    pcmLen = pcmLen/360;//Ö¡Êý
    melp_param_save_init(pcmLen);
